  ...
  async computeRoute({
    ...
    try {
      ...
      return {
        ...
        shadePercentage: 80,
        comfortScore: 88,
        routeAdvice: '捷運連通道與騎樓覆蓋率達 80%，曝曬程度極低。',
        segments: [
          { mode: 'WALK', instruction: '從目前位置步行至鄰近捷運站 (地下化)', duration_minutes: 4, distance_meters: 250, is_shaded_or_underground: true },
          { mode: 'SUBWAY', instruction: '搭乘捷運抵達目標站點', duration_minutes: 14, distance_meters: 2700, is_shaded_or_underground: true },
          { mode: 'WALK', instruction: `由地下街出口直通 ${destName}`, duration_minutes: 4, distance_meters: 250, is_shaded_or_underground: true },
        ],
        path: [
          { lat: originLat, lng: originLng },
